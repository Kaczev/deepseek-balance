...
// ★ "今日已X.XX¥"：跟在标题同一行的**后面**，灰色（边缘文字色 #afb2b7），字号小于标题。
//  数字与"已"之间**没有空格**（所有者 2026-09-19："可以改成'今日已15.32¥'"）。
//
...
//              画得下，15 位（167.1）画不下；
//              g = 18 -> 预算 136 DIP —— 11 位 "今日已999999999.99¥"（132.8）画得下，
//              12 位（140.4）画不下。
...
//    （"今日已99999.99¥"，102.3 DIP）的 1.33 倍。再大就开始像"两段无关的字"了；
